...
const About = () => (
    <>
        ...
        <div className="pair-item" style={{ paddingLeft: `3rem`, textIndent: `-3rem`, color: `rgb(255,255,255,0.92)`,fontFamily: `'Roboto'`, fontSize: `0.9rem`, marginBottom: `0.3rem`, textAlign: `justify`}}>
            <Span className="key" style={{ marginRight: `1rem`,}}>1993</Span>
            Born
        </div>
        <div className="pair-item" style={{ paddingLeft: `3rem`, textIndent: `-3rem`, color: `rgb(255,255,255,0.92)`,fontFamily: `'Roboto'`, fontSize: `0.9rem`}}>
        ...
        <a href="https://www.linkedin.com/in/raghavkanwal" target="_blank" rel="noreferrer">
            ...
            <Span className="key" style={{ marginRight: `1rem`,}}>
