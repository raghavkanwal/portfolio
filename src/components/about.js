...
const About = () => (
    <>
        ...
        <div class="pair-item" style={{ paddingLeft: `3rem`, textIndent: `-3rem`, color: `rgb(255,255,255,0.92`,fontFamily: `'Roboto'`, marginBottom: `0.3rem`, textAlign: `justify`}}>
            <Span class="key" style={{ marginRight: `1rem`,}}>1993</Span>
            Born
        </div>
        <div class="pair-item" style={{ paddingLeft: `3rem`, textIndent: `-3rem`, color: `rgb(255,255,255,0.92`,fontFamily: `'Roboto'`}}>
